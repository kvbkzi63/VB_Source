...
AmCharts.formatDate = function(a, b) {
    ...
    //james
    //if (!this.zooming)
    window.external.notify(a.getFullYear().toString() + "/" + (a.getMonth() + 1).toString() + "/" + a.getDate().toString() + " " + a.getHours() + ":00");
    //
