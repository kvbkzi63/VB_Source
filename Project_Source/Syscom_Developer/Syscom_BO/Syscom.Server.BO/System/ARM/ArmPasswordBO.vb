...
Public Class ArmPasswordBO
    'Syscom's CodeGen Produced This VB Code @ 2017/7/5 上午 10:36:13
    Public Shared ReadOnly tableName As String="ARM_Password"
    Private Shared myInstance As ArmPasswordBO
    Public Shared Function GetInstance() As ArmPasswordBO
        If myInstance Is Nothing Then
            myInstance = New ArmPasswordBO()
        End If 
        Return myInstance 
    End Function
...
#Region " 新增"
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Employee_Code , Password , Password_org , Modified_Date ) " & _ 
             " values( @Employee_Code , @Password , @Password_org , @Modified_Date             )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Password", row.Item("Password"))
                        Command.Parameters.AddWithValue("@Password_org", row.Item("Password_org"))
                        Command.Parameters.AddWithValue("@Modified_Date", row.Item("Modified_Date"))
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Password=@Password , Password_org=@Password_org , Modified_Date=@Modified_Date " & _ 
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_Employee_Code As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" Employee_Code , Password , Password_org , Modified_Date                from " & tableName)
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Employee_Code , Password , Password_org , Modified_Date            from " & tableName & " where 1=1 ")
