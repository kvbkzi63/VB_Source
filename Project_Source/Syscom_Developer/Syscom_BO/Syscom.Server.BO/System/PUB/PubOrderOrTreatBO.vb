...
Public Class PubOrderOrTreatBO
    ...
    Private Shared myInstance As PubOrderOrTreatBO
    Public Shared Function GetInstance() As PubOrderOrTreatBO
        If myInstance Is Nothing Then
            myInstance = New PubOrderOrTreatBO()
        End If 
        Return myInstance 
    End Function
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Order_Code , Is_Single_Or , Is_Body_Site , Default_Body_Site_Code , Default_Side_Id " & _ 
             "  ) " & _ 
             " values( @Order_Code , @Is_Single_Or , @Is_Body_Site , @Default_Body_Site_Code , @Default_Side_Id " & _ 
             "              )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Is_Single_Or", row.Item("Is_Single_Or"))
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Is_Single_Or=@Is_Single_Or , Is_Body_Site=@Is_Body_Site , Default_Body_Site_Code=@Default_Body_Site_Code , Default_Side_Id=@Default_Side_Id " & _ 
            "  " & _ 
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_Order_Code As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" Order_Code , Is_Single_Or , Is_Body_Site , Default_Body_Site_Code , Default_Side_Id ") 
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Order_Code , Is_Single_Or , Is_Body_Site , Default_Body_Site_Code , Default_Side_Id " & _ 
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Order_Or_Treat 在所屬資料庫的連線
    ''' </summary>
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Order_Or_Treat 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
