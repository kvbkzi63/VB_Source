...
Public Class PubConfigBO
    'Syscom's CodeGen Produced This VB Code @ 2015/7/24 上午 07:48:47
    Public Shared ReadOnly tableName As String="PUB_Config"
    Private Shared myInstance As PubConfigBO
    Public Shared Function GetInstance() As PubConfigBO
        If myInstance Is Nothing Then
            myInstance = New PubConfigBO()
        End If 
        Return myInstance 
    End Function
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        End With
                        Command.Parameters.AddWithValue("@Config_Name", row.Item("Config_Name"))
                        Command.Parameters.AddWithValue("@Config_Description", row.Item("Config_Description"))
                        Command.Parameters.AddWithValue("@Config_Value", row.Item("Config_Value"))
...
#Region " 刪除"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function delete(ByRef pk_Config_Name As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        Dim connFlag As Boolean = conn Is Nothing
        Try
                  deleteBackup(pk_Config_Name,conn) '備份機制
            Dim count As Integer = 0
...
#Region " 查詢"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function queryByPK(ByRef pk_Config_Name As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        Dim connFlag As Boolean = conn Is Nothing
        Try
            Dim ds As DataSet
            If connFlag Then
            ...
            content.AppendLine(" Config_Name , Config_Description , Config_Value , Create_User , Create_Time ,  ") 
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function queryByLikePK(ByRef pk_Config_Name As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        Dim connFlag As Boolean = conn Is Nothing
        Try
            Dim ds As DataSet
            If connFlag Then
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Config_Name , Config_Description , Config_Value , Create_User , Create_Time ,  " & _ 
...
#Region " 備份"
    ...
    Public Shared Function getDataTableBKWithSchema() As DataTable
        Try
            ...
            dt.Columns.Add("Config_Name")
            dt.Columns("Config_Name").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("Config_Description")
            dt.Columns("Config_Description").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("Config_Value")
            dt.Columns("Config_Value").DataType = System.Type.GetType("System.String")
            ...
            pkColArray(2) = dt.Columns("Config_Name")
    ...
    End Function 
        ...
        Protected Sub dataBackup(ByRef action As String, ByRef row As DataRow)
            ...
            bkRow("Backup_Time") = Now
                bkRow("Config_Name") = row.Item("Config_Name")
                bkRow("Config_Description") = row.Item("Config_Description")
                bkRow("Config_Value") = row.Item("Config_Value")
        ...
        ''' 備份刪除資料
        ''' </summary>       
        Protected Sub deleteBackup(ByVal pk_Config_Name As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing)
    
            Dim bkDS As System.Data.DataSet = queryByPK(pk_Config_Name, conn)
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Config 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
