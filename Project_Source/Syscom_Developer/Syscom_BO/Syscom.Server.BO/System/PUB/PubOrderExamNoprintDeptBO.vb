...
Public Class PubOrderExamNoprintDeptBO
   Inherits Syscom.Comm.LOG.LOGDelegate
    'Syscom's CodeGen Produced This VB Code @ 2017/3/14 上午 11:00:09
    Public Shared ReadOnly tableName As String="PUB_Order_Exam_NoPrint_Dept"
    Private Shared myInstance As PubOrderExamNoprintDeptBO
    Public Shared Function GetInstance() As PubOrderExamNoprintDeptBO
        If myInstance Is Nothing Then
            myInstance = New PubOrderExamNoprintDeptBO()
        End If 
        Return myInstance 
    End Function
...
#Region " 備份"
    ...
    End Function 
        ...
        Catch ex As Exception
                ...
                command.Parameters("@LOG_Class").Value = "PUBOrderExamNoPrintDeptBO.vb"
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Order_Exam_NoPrint_Dept 在所屬資料庫的連線
    ''' </summary>
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Order_Exam_NoPrint_Dept 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
