...
Public Class PubDentalAddBO
    'Syscom's CodeGen Produced This VB Code @ 2015/7/24 上午 07:48:48
    Public Shared ReadOnly tableName As String="PUB_Dental_Add"
    Private Shared myInstance As PubDentalAddBO
    Public Shared Function GetInstance() As PubDentalAddBO
        If myInstance Is Nothing Then
            myInstance = New PubDentalAddBO()
        End If 
        Return myInstance 
    End Function
...
#Region " 新增"
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Effect_Date , Main_Identity_Id , Pt_From_Id , Order_Code , Dental_Add_Ratio ,  " & _ 
             " Dc , End_Date , Create_User , Create_Time , Modified_User ,  " & _ 
             " Modified_Time ) " & _ 
             " values( @Effect_Date , @Main_Identity_Id , @Pt_From_Id , @Order_Code , @Dental_Add_Ratio ,  " & _ 
             " @Dc , @End_Date , @Create_User , @Create_Time , @Modified_User ,  " & _ 
             " @Modified_Time             )"
            If connFlag Then
                conn = getConnection()
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Dental_Add_Ratio=@Dental_Add_Ratio " & _ 
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_Effect_Date As System.DateTime,ByRef pk_Main_Identity_Id As System.String,ByRef pk_Pt_From_Id As System.String,ByRef pk_Order_Code As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" Effect_Date , Main_Identity_Id , Pt_From_Id , Order_Code , Dental_Add_Ratio ,  ") 
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Effect_Date , Main_Identity_Id , Pt_From_Id , Order_Code , Dental_Add_Ratio ,  " & _ 
             " Dc , End_Date , Create_User , Create_Time , Modified_User ,  " & _ 
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Dental_Add 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
