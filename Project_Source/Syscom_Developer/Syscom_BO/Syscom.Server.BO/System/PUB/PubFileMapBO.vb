...
Public Class PubFileMapBO
    'Syscom's CodeGen Produced This VB Code @ 2015/7/24 上午 07:48:49
    Public Shared ReadOnly tableName As String="PUB_File_Map"
    Private Shared myInstance As PubFileMapBO
    Public Shared Function GetInstance() As PubFileMapBO
        If myInstance Is Nothing Then
            myInstance = New PubFileMapBO()
        End If 
        Return myInstance 
    End Function
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " FID , File_Name , Order_Seq , Image_Thumb , File_Note ,  " & _ 
             ...
             " values( @FID , @File_Name , @Order_Seq , @Image_Thumb , @File_Note ,  " & _ 
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Order_Seq", row.Item("Order_Seq"))
                        Command.Parameters.AddWithValue("@Image_Thumb", row.Item("Image_Thumb"))
                        Command.Parameters("@Image_Thumb").DbType = DbType.Binary
                        Command.Parameters.AddWithValue("@File_Note", row.Item("File_Note"))
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " File_Name=@File_Name , Order_Seq=@Order_Seq , Image_Thumb=@Image_Thumb , File_Note=@File_Note " & _ 
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_FID As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" FID , File_Name , Order_Seq , Image_Thumb , File_Note ,  ") 
            content.AppendLine(" Create_User , Create_Time , Modified_User , Modified_Time                from " & tableName)
            content.AppendLine("   where FID=@FID            " )
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function queryByLikePK(ByRef pk_FID As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        Dim connFlag As Boolean = conn Is Nothing
        Try
            Dim ds As DataSet
            If connFlag Then
            ...
            content.AppendLine(" FID , File_Name , Order_Seq , Image_Thumb , File_Note ,  ") 
            content.AppendLine(" Create_User , Create_Time , Modified_User , Modified_Time                from " & tableName)
            content.AppendLine("   where FID like @FID "   )
            command.CommandText = content.tostring 
            Command.Parameters.AddWithValue("@FID",pk_FID & "%")
            Using adapter As SqlDataAdapter = New SqlDataAdapter(command)
                ds = New DataSet(tableName)
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   FID , File_Name , Order_Seq , Image_Thumb , File_Note ,  " & _ 
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_File_Map 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
