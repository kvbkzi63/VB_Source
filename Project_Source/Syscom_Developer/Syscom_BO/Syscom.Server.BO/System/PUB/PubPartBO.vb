...
Public Class PubPartBO
    'Syscom's CodeGen Produced This VB Code @ 2015/7/24 上午 07:48:51
    Public Shared ReadOnly tableName As String="PUB_Part"
    Private Shared myInstance As PubPartBO
    Public Shared Function GetInstance() As PubPartBO
        If myInstance Is Nothing Then
            myInstance = New PubPartBO()
        End If 
        Return myInstance 
    End Function
...
#Region " 刪除"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function delete(ByRef pk_Effect_Date As System.DateTime,ByRef pk_Part_Code As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        Dim connFlag As Boolean = conn Is Nothing
        Try
            Dim count As Integer = 0
...
#Region " 查詢"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function queryByPK(ByRef pk_Effect_Date As System.DateTime,ByRef pk_Part_Code As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        Dim connFlag As Boolean = conn Is Nothing
        Try
            Dim ds As DataSet
            If connFlag Then
            ...
            content.AppendLine(" Effect_Date , Part_Code , Part_Name , Part_Ratio , Part_Amt ,  ") 
            content.AppendLine(" Dc , End_Date , Create_User , Create_Time , Modified_User ,  ") 
            content.AppendLine(" Modified_Time                from " & tableName)
            content.AppendLine("   where Effect_Date=@Effect_Date and Part_Code=@Part_Code            " )
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function queryByLikePK(ByRef pk_Effect_Date As System.DateTime,ByRef pk_Part_Code As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        Dim connFlag As Boolean = conn Is Nothing
        Try
            Dim ds As DataSet
            If connFlag Then
            ...
            content.AppendLine(" Dc , End_Date , Create_User , Create_Time , Modified_User ,  ") 
            content.AppendLine(" Modified_Time                from " & tableName)
            content.AppendLine("   where Effect_Date like @Effect_Date and Part_Code like @Part_Code "   )
            command.CommandText = content.tostring 
            Command.Parameters.AddWithValue("@Effect_Date",pk_Effect_Date & "%")
            Command.Parameters.AddWithValue("@Part_Code",pk_Part_Code & "%")
            Using adapter As SqlDataAdapter = New SqlDataAdapter(command)
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Effect_Date , Part_Code , Part_Name , Part_Ratio , Part_Amt ,  " & _ 
             " Dc , End_Date , Create_User , Create_Time , Modified_User ,  " & _ 
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Part 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
