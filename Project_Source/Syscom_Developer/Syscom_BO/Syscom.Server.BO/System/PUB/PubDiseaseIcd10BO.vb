...
Public Class PubDiseaseIcd10BO
    'Syscom's CodeGen Produced This VB Code @ 2017/1/19 下午 05:37:04
    Public Shared ReadOnly tableName As String = "PUB_Disease_ICD10"
    Private Shared myInstance As PubDiseaseIcd10BO
    Public Shared Function GetInstance() As PubDiseaseIcd10BO
        If myInstance Is Nothing Then
            myInstance = New PubDiseaseIcd10BO()
        End If
        Return myInstance
    End Function
        ...
        Try
            ...
            For Each row As DataRow In ds.Tables(0).Rows
                Using command As SqlCommand = New SqlCommand
                    ...
                    Command.Parameters.AddWithValue("@Is_Detail", row.Item("Is_Detail"))
                    Command.Parameters.AddWithValue("@ICD10_Chapter_Id", row.Item("ICD10_Chapter_Id"))
                    Command.Parameters.AddWithValue("@Severe_Disase_Id", row.Item("Severe_Disase_Id"))
                    Command.Parameters.AddWithValue("@Rare_Disease_Id", row.Item("Rare_Disease_Id"))
                    Command.Parameters.AddWithValue("@Chronic_Disease_Id", row.Item("Chronic_Disease_Id"))
                    Command.Parameters.AddWithValue("@Create_User", row.Item("Create_User"))
                    Command.Parameters.AddWithValue("@Create_Time", currentTime)
                    Command.Parameters.AddWithValue("@Modified_User", row.Item("Modified_User"))
                    Command.Parameters.AddWithValue("@Modified_Time", currentTime)
                    Command.Parameters.AddWithValue("@Icd_Code_Nodot", row.Item("Icd_Code_Nodot"))
                    Command.Parameters.AddWithValue("@Is_End_Flag", row.Item("Is_End_Flag"))
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet, Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            "  , Is_Hem_Original_Disease=@Is_Hem_Original_Disease , Dc=@Dc , End_Date=@End_Date , Is_Or=@Is_Or , Is_Drg=@Is_Drg " & _
            "  , Is_Detail=@Is_Detail , ICD10_Chapter_Id=@ICD10_Chapter_Id , Severe_Disase_Id=@Severe_Disase_Id , Rare_Disease_Id=@Rare_Disease_Id , Chronic_Disease_Id=@Chronic_Disease_Id " & _
            "  , Modified_User=@Modified_User , Modified_Time=@Modified_Time , Icd_Code_Nodot=@Icd_Code_Nodot " & _
            "  , Is_End_Flag=@Is_End_Flag " & _
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_Effect_Date As System.DateTime, ByRef pk_Icd_Code As System.String, ByRef pk_Disease_Type_Id As System.String, Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" Is_Hem_Original_Disease , Dc , End_Date , Is_Or , Is_Drg ,  ")
            content.AppendLine(" Is_Detail , ICD10_Chapter_Id , Severe_Disase_Id , Rare_Disease_Id , Chronic_Disease_Id ,  ")
            content.AppendLine(" Create_User , Create_Time , Modified_User , Modified_Time , Icd_Code_Nodot ,  ")
            content.AppendLine(" Is_End_Flag                from " & tableName)
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(), Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Effect_Date , Icd_Code , Disease_Type_Id , Disease_En_Name , Disease_Name ,  " & _
             ...
             " Is_Detail , ICD10_Chapter_Id , Severe_Disase_Id , Rare_Disease_Id , Chronic_Disease_Id ,  " & _
             " Create_User , Create_Time , Modified_User , Modified_Time , Icd_Code_Nodot ,  " & _
             " Is_End_Flag            from " & tableName & " where 1=1 ")
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Disease_ICD10 在所屬資料庫的連線
    ''' </summary>
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Disease_ICD10 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
