...
Public Class PubExamItemBO
    'Syscom's CodeGen Produced This VB Code @ 2015/7/24 上午 07:48:49
    Public Shared ReadOnly tableName As String="PUB_Exam_Item"
    Private Shared myInstance As PubExamItemBO
    Public Shared Function GetInstance() As PubExamItemBO
        If myInstance Is Nothing Then
            myInstance = New PubExamItemBO()
        End If 
        Return myInstance 
    End Function
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Order_Code , Display_Name , Item_Option , Other_Side_Code1 , Other_Side_Code2 " & _ 
             "  ) " & _ 
             " values( @Order_Code , @Display_Name , @Item_Option , @Other_Side_Code1 , @Other_Side_Code2 " & _ 
             "              )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Display_Name", row.Item("Display_Name"))
                        Command.Parameters.AddWithValue("@Item_Option", row.Item("Item_Option"))
                        Command.Parameters.AddWithValue("@Other_Side_Code1", row.Item("Other_Side_Code1"))
                        Command.Parameters.AddWithValue("@Other_Side_Code2", row.Item("Other_Side_Code2"))
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Display_Name=@Display_Name , Item_Option=@Item_Option , Other_Side_Code1=@Other_Side_Code1 , Other_Side_Code2=@Other_Side_Code2 " & _ 
            "  " & _ 
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_Order_Code As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" Order_Code , Display_Name , Item_Option , Other_Side_Code1 , Other_Side_Code2 ") 
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Order_Code , Display_Name , Item_Option , Other_Side_Code1 , Other_Side_Code2 " & _ 
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 PUB_Exam_Item 在實體位置的資料庫連線，用在新增、修改、刪除、即時查詢的功能上 
    ''' </summary>
    ''' <returns>資料庫連線</returns>
    ''' <remarks></remarks>
