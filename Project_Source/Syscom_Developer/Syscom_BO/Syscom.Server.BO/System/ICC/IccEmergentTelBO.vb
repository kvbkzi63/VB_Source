...
Imports System.Data
Public Class IccEmergentTelBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:31
    Public Shared ReadOnly tableName as String="ICC_Emergent_Tel"
    Private Shared myInstance As IccEmergentTelBO
    Public Shared Function GetInstance() As IccEmergentTelBO
        If myInstance Is Nothing Then
            myInstance = New IccEmergentTelBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , TEL , Create_Time ) " & _ 
             " values( @Card_Sn , @TEL , @Create_Time             )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@TEL", row.Item("TEL"))
    ...
    ''' <summary>
    '''取得表格 ICC_Emergent_Tel 在所屬資料庫的連線
    ''' </summary>
