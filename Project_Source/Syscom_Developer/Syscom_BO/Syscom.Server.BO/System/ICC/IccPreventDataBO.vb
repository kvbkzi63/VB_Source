...
Imports System.Data
Public Class IccPreventDataBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:37
    Public Shared ReadOnly tableName as String="ICC_Prevent_Data"
    Private Shared myInstance As IccPreventDataBO
    Public Shared Function GetInstance() As IccPreventDataBO
        If myInstance Is Nothing Then
            myInstance = New IccPreventDataBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet, Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , Service_Item_Id , ExamDate , Hospital_Code ,  " & _
             " Exam_Item_Id , Create_Time ) " & _
             " values( @Card_Sn , @Row_No , @Service_Item_Id , @ExamDate , @Hospital_Code ,  " & _
             " @Exam_Item_Id , @Create_Time             )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
            For Each row As DataRow In ds.Tables(0).Rows
                Using command As SqlCommand = New SqlCommand
                    ...
                    Command.Parameters.AddWithValue("@Service_Item_Id", row.Item("Service_Item_Id"))
                    Command.Parameters.AddWithValue("@ExamDate", row.Item("ExamDate"))
                    Command.Parameters.AddWithValue("@Hospital_Code", row.Item("Hospital_Code"))
                    Command.Parameters.AddWithValue("@Exam_Item_Id", row.Item("Exam_Item_Id"))
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Service_Item_Id=@Service_Item_Id , ExamDate=@ExamDate , Hospital_Code=@Hospital_Code " & _ 
            "  , Exam_Item_Id=@Exam_Item_Id " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Prevent_Data 在所屬資料庫的連線
    ''' </summary>
