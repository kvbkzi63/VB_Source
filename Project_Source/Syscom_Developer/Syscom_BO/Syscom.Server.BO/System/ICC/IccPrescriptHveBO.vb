...
Imports System.Data
Public Class IccPrescriptHveBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:36
    Public Shared ReadOnly tableName as String="ICC_Prescript_HVE"
    Private Shared myInstance As IccPrescriptHveBO
    Public Shared Function GetInstance() As IccPrescriptHveBO
        If myInstance Is Nothing Then
            myInstance = New IccPrescriptHveBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , ImplDate , Hospital_Code , HVE_Code ,  " & _ 
             " Part_Id , Tqty , Create_Time ) " & _ 
             " values( @Card_Sn , @Row_No , @ImplDate , @Hospital_Code , @HVE_Code ,  " & _ 
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@ImplDate", row.Item("ImplDate"))
                        Command.Parameters.AddWithValue("@Hospital_Code", row.Item("Hospital_Code"))
                        Command.Parameters.AddWithValue("@HVE_Code", row.Item("HVE_Code"))
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " ImplDate=@ImplDate , Hospital_Code=@Hospital_Code , HVE_Code=@HVE_Code " & _ 
            "  , Part_Id=@Part_Id , Tqty=@Tqty " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Prescript_HVE 在所屬資料庫的連線
    ''' </summary>
