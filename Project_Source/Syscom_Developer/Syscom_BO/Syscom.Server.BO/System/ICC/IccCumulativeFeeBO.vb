...
Imports System.Data
Public Class IccCumulativeFeeBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:31
    Public Shared ReadOnly tableName as String="ICC_Cumulative_Fee"
    Private Shared myInstance As IccCumulativeFeeBO
    Public Shared Function GetInstance() As IccCumulativeFeeBO
        If myInstance Is Nothing Then
            myInstance = New IccCumulativeFeeBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Outpatient_Fee_Toatl , Hospital_Fee_Toatl , Create_Time ) " & _ 
             " values( @Card_Sn , @Outpatient_Fee_Toatl , @Hospital_Fee_Toatl , @Create_Time             )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Outpatient_Fee_Toatl", row.Item("Outpatient_Fee_Toatl"))
                        Command.Parameters.AddWithValue("@Hospital_Fee_Toatl", row.Item("Hospital_Fee_Toatl"))
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Outpatient_Fee_Toatl=@Outpatient_Fee_Toatl , Hospital_Fee_Toatl=@Hospital_Fee_Toatl " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Cumulative_Fee 在所屬資料庫的連線
    ''' </summary>
