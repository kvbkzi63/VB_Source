...
Imports System.Data
Public Class IccPrescriptLongTermBO
    ...
    Private Shared myInstance As IccPrescriptLongTermBO
    Public Shared Function GetInstance() As IccPrescriptLongTermBO
        If myInstance Is Nothing Then
            myInstance = New IccPrescriptLongTermBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , CreateDate , Medicine_Code , Usage_Code ,  " & _ 
             " Days , Tqty , Create_Time ) " & _ 
             " values( @Card_Sn , @Row_No , @CreateDate , @Medicine_Code , @Usage_Code ,  " & _ 
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@CreateDate", row.Item("CreateDate"))
                        Command.Parameters.AddWithValue("@Medicine_Code", row.Item("Medicine_Code"))
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " CreateDate=@CreateDate , Medicine_Code=@Medicine_Code , Usage_Code=@Usage_Code " & _ 
            "  , Days=@Days , Tqty=@Tqty " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Prescript_Long_Term 在所屬資料庫的連線
    ''' </summary>
