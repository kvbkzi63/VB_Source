...
Imports System.Data
Public Class IccPrescriptMainBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:37
    Public Shared ReadOnly tableName as String="ICC_Prescript_Main"
    Private Shared myInstance As IccPrescriptMainBO
    Public Shared Function GetInstance() As IccPrescriptMainBO
        If myInstance Is Nothing Then
            myInstance = New IccPrescriptMainBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , TreatmentTime , Order_Type_Id , Treatment_Item_Code ,  " & _ 
             ...
             " Create_Time ) " & _ 
             " values( @Card_Sn , @Row_No , @TreatmentTime , @Order_Type_Id , @Treatment_Item_Code ,  " & _ 
             " @Part_Id , @Usage_Code , @Days , @Tqty , @Prescript_Mark_Id ,  " & _ 
             " @Create_Time             )"
            If connFlag Then
                conn = getConnection()
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Treatment_Item_Code", row.Item("Treatment_Item_Code"))
                        Command.Parameters.AddWithValue("@Part_Id", row.Item("Part_Id"))
                        ...
                        Command.Parameters.AddWithValue("@Prescript_Mark_Id", row.Item("Prescript_Mark_Id"))
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " TreatmentTime=@TreatmentTime , Order_Type_Id=@Order_Type_Id , Treatment_Item_Code=@Treatment_Item_Code " & _ 
            "  , Part_Id=@Part_Id , Usage_Code=@Usage_Code , Days=@Days , Tqty=@Tqty , Prescript_Mark_Id=@Prescript_Mark_Id " & _ 
            "  " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Prescript_Main 在所屬資料庫的連線
    ''' </summary>
