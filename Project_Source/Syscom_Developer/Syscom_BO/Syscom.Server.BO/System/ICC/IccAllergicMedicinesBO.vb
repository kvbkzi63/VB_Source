...
Imports System.Data
Public Class IccAllergicMedicinesBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:29
    Public Shared ReadOnly tableName as String="ICC_Allergic_Medicines"
    Private Shared myInstance As IccAllergicMedicinesBO
    Public Shared Function GetInstance() As IccAllergicMedicinesBO
        If myInstance Is Nothing Then
            myInstance = New IccAllergicMedicinesBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , Element , Create_Time ) " & _ 
             " values( @Card_Sn , @Row_No , @Element , @Create_Time             )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Element", row.Item("Element"))
    ...
    ''' <summary>
    '''取得表格 ICC_Allergic_Medicines 在所屬資料庫的連線
    ''' </summary>
