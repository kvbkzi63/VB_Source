...
Imports System.Data
Public Class IccCriticalIllnessBO
    ...
    Private Shared myInstance As IccCriticalIllnessBO
    Public Shared Function GetInstance() As IccCriticalIllnessBO
        If myInstance Is Nothing Then
            myInstance = New IccCriticalIllnessBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , Illness_Id , Expired_StartDate , Expired_EndDate ,  " & _ 
             " Is_Part , Is_All , Create_Time ) " & _ 
             " values( @Card_Sn , @Row_No , @Illness_Id , @Expired_StartDate , @Expired_EndDate ,  " & _ 
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Illness_Id", row.Item("Illness_Id"))
                        Command.Parameters.AddWithValue("@Expired_StartDate", row.Item("Expired_StartDate"))
                        Command.Parameters.AddWithValue("@Expired_EndDate", row.Item("Expired_EndDate"))
                        Command.Parameters.AddWithValue("@Is_Part", row.Item("Is_Part"))
                        Command.Parameters.AddWithValue("@Is_All", row.Item("Is_All"))
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Illness_Id=@Illness_Id , Expired_StartDate=@Expired_StartDate , Expired_EndDate=@Expired_EndDate " & _ 
            "  , Is_Part=@Is_Part , Is_All=@Is_All " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Critical_Illness 在所屬資料庫的連線
    ''' </summary>
