...
Imports System.Data
Public Class IccPredeliveryDataBO
    ...
    Private Shared myInstance As IccPredeliveryDataBO
    Public Shared Function GetInstance() As IccPredeliveryDataBO
        If myInstance Is Nothing Then
            myInstance = New IccPredeliveryDataBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet, Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , ExamDate , Hospital_Code , Exam_Item_Id ,  " & _
             " Create_Time ) " & _
             " values( @Card_Sn , @Row_No , @ExamDate , @Hospital_Code , @Exam_Item_Id ,  " & _
             " @Create_Time             )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " ExamDate=@ExamDate , Hospital_Code=@Hospital_Code , Exam_Item_Id=@Exam_Item_Id " & _ 
            "  " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Predelivery_Data 在所屬資料庫的連線
    ''' </summary>
