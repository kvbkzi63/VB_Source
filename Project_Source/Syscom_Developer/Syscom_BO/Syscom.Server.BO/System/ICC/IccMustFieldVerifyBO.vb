...
Public Class IccMustFieldVerifyBO
    ...
    Private Shared myInstance As IccMustFieldVerifyBO
    Public Shared Function GetInstance() As IccMustFieldVerifyBO
        If myInstance Is Nothing Then
            myInstance = New IccMustFieldVerifyBO()
        End If 
        Return myInstance 
    End Function
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Serial_Sn , Treatment_Category_Id , ID , Is_Normal_Data , Is_Abnormal_Data ,  " & _ 
             ...
             "  ) " & _ 
             " values( @Serial_Sn , @Treatment_Category_Id , @ID , @Is_Normal_Data , @Is_Abnormal_Data ,  " & _ 
             " @Field_Rule , @Create_User , @Create_Time , @Modified_User , @Modified_Time " & _ 
             "              )"
            If connFlag Then
                conn = getConnection()
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Is_Normal_Data", row.Item("Is_Normal_Data"))
                        Command.Parameters.AddWithValue("@Is_Abnormal_Data", row.Item("Is_Abnormal_Data"))
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Treatment_Category_Id=@Treatment_Category_Id , ID=@ID , Is_Normal_Data=@Is_Normal_Data , Is_Abnormal_Data=@Is_Abnormal_Data " & _ 
            "  , Field_Rule=@Field_Rule , Modified_User=@Modified_User , Modified_Time=@Modified_Time " & _ 
            "  " & _ 
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_Serial_Sn As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" Serial_Sn , Treatment_Category_Id , ID , Is_Normal_Data , Is_Abnormal_Data ,  ") 
            content.AppendLine(" Field_Rule , Create_User , Create_Time , Modified_User , Modified_Time ") 
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Serial_Sn , Treatment_Category_Id , ID , Is_Normal_Data , Is_Abnormal_Data ,  " & _ 
             " Field_Rule , Create_User , Create_Time , Modified_User , Modified_Time " & _ 
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 ICC_Must_Field_Verify 在所屬資料庫的連線
    ''' </summary>
