...
Imports System.Data
Public Class IccLastSeqNumBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:34
    Public Shared ReadOnly tableName as String="ICC_Last_Seq_Num"
    Private Shared myInstance As IccLastSeqNumBO
    Public Shared Function GetInstance() As IccLastSeqNumBO
        If myInstance Is Nothing Then
            myInstance = New IccLastSeqNumBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Last_Sn , Create_Time ) " & _ 
             " values( @Card_Sn , @Last_Sn , @Create_Time             )"
            If connFlag Then
                conn = getConnection()
                conn.Open()
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@Last_Sn", row.Item("Last_Sn"))
    ...
    ''' <summary>
    '''取得表格 ICC_Last_Seq_Num 在所屬資料庫的連線
    ''' </summary>
