...
Public Class IccInteractVerify2BO
    ...
    Private Shared myInstance As IccInteractVerify2BO
    Public Shared Function GetInstance() As IccInteractVerify2BO
        If myInstance Is Nothing Then
            myInstance = New IccInteractVerify2BO()
        End If 
        Return myInstance 
    End Function
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Serial_Sn , ID1 , ID1_Values , ID2 , ID2_Values ,  " & _ 
             ...
             "  ) " & _ 
             " values( @Serial_Sn , @ID1 , @ID1_Values , @ID2 , @ID2_Values ,  " & _ 
             " @Is_Zero_Or_Empty , @Create_User , @Create_Time , @Modified_User , @Modified_Time " & _ 
             "              )"
            If connFlag Then
                conn = getConnection()
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@ID1_Values", row.Item("ID1_Values"))
                        Command.Parameters.AddWithValue("@ID2", row.Item("ID2"))
                        Command.Parameters.AddWithValue("@ID2_Values", row.Item("ID2_Values"))
                        Command.Parameters.AddWithValue("@Is_Zero_Or_Empty", row.Item("Is_Zero_Or_Empty"))
...
#Region " 修改"
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " ID1=@ID1 , ID1_Values=@ID1_Values , ID2=@ID2 , ID2_Values=@ID2_Values " & _ 
            "  , Is_Zero_Or_Empty=@Is_Zero_Or_Empty , Modified_User=@Modified_User , Modified_Time=@Modified_Time " & _ 
            "  " & _ 
...
#Region " 查詢"
    ...
    Public Function queryByPK(ByRef pk_Serial_Sn As System.String,Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.AppendLine(" Serial_Sn , ID1 , ID1_Values , ID2 , ID2_Values ,  ") 
            content.AppendLine(" Is_Zero_Or_Empty , Create_User , Create_Time , Modified_User , Modified_Time ") 
    ...
    Public Function dynamicQueryWithColumnValue(ByRef columnName As String(), ByRef columnValue As Object(),Optional ByRef conn As System.Data.IDbConnection = Nothing) As System.Data.DataSet
        ...
        Try
            ...
            content.Append("select   Serial_Sn , ID1 , ID1_Values , ID2 , ID2_Values ,  " & _ 
             " Is_Zero_Or_Empty , Create_User , Create_Time , Modified_User , Modified_Time " & _ 
...
#Region " 取得所屬資料庫的連線"
    ...
    ''' <summary>
    '''取得表格 ICC_Interact_Verify2 在所屬資料庫的連線
    ''' </summary>
