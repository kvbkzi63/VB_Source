...
Imports System.Data
Public Class IccInoculateDataBO
    'Roger's CodeGen Produced This VB Code @ 2010/7/1 上午 10:56:32
    Public Shared ReadOnly tableName as String="ICC_Inoculate_Data"
    Private Shared myInstance As IccInoculateDataBO
    Public Shared Function GetInstance() As IccInoculateDataBO
        If myInstance Is Nothing Then
            myInstance = New IccInoculateDataBO()
        End If 
        Return myInstance 
    End Function
    ''' <summary>
    ...
    Public Function insert(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Card_Sn , Row_No , Type , GivenDate , Hospital_Code ,  " & _ 
             " Batch_Code , Create_Time ) " & _ 
             " values( @Card_Sn , @Row_No , @Type , @GivenDate , @Hospital_Code ,  " & _ 
            ...
            End If
                For Each row As DataRow In ds.Tables(0).Rows
                  Using command As SqlCommand = New SqlCommand
                        ...
                        Command.Parameters.AddWithValue("@GivenDate", row.Item("GivenDate"))
                        Command.Parameters.AddWithValue("@Hospital_Code", row.Item("Hospital_Code"))
                        Command.Parameters.AddWithValue("@Batch_Code", row.Item("Batch_Code"))
    ...
    Public Function update(ByVal ds As System.Data.DataSet,Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            " Type=@Type , GivenDate=@GivenDate , Hospital_Code=@Hospital_Code " & _ 
    ...
    ''' <summary>
    '''取得表格 ICC_Inoculate_Data 在所屬資料庫的連線
    ''' </summary>
