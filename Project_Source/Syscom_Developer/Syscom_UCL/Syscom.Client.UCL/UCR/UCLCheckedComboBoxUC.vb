...
Public Class UCLCheckedComboBoxUC
    Inherits ComboBox
    ''' <summary>
    ...
    Friend Shadows Class Dropdown
        ...
        Friend Class CustomCheckedListBox
            ...
            Protected Overrides Sub OnKeyDown(ByVal e As KeyEventArgs)
                If e.KeyCode = Keys.Enter Then
                    ' Enact selection.
                    DirectCast(Parent, UCLCheckedComboBoxUC.Dropdown).OnDeactivate(New CCBoxEventArgs(Nothing, True))

                    e.Handled = True
                ElseIf e.KeyCode = Keys.Escape Then
                    ' Cancel selection.
                    DirectCast(Parent, UCLCheckedComboBoxUC.Dropdown).OnDeactivate(New CCBoxEventArgs(Nothing, False))
        ...
        Private ccbParent As UCLCheckedComboBoxUC
        ...
        Public Sub New(ByVal ccbParent As UCLCheckedComboBoxUC)
    ...
    Private dropdown_1 As Dropdown
    ...
    Private Sub DoDropDown()
        If Not dropdown_1.Visible Then
            Dim rect As Rectangle = RectangleToScreen(Me.ClientRectangle)
            dropdown_1.Location = New Point(rect.X, rect.Y + Me.Size.Height)
            Dim count As Integer = dropdown_1.List.Items.Count
            If count > Me.MaxDropDownItems Then
                count = Me.MaxDropDownItems
            ElseIf count = 0 Then
                count = 1
            End If
            dropdown_1.Size = New Size(Me.Size.Width, (dropdown_1.List.ItemHeight) * count + 2)
            dropdown_1.Show(Me)
        End If
    End Sub
    ...
    Public Function GetItemChecked(ByVal index As Integer) As Boolean
        ...
        Else
            Return dropdown_1.List.GetItemChecked(index)
        End If
    End Function
    ...
    Public Sub SetItemChecked(ByVal index As Integer, ByVal isChecked As Boolean)
        ...
        If index < 0 OrElse index > Items.Count Then
            Throw New ArgumentOutOfRangeException("index", "value out of range")
        Else
            dropdown_1.List.SetItemChecked(index, isChecked)
            ' Need to update the Text.
            Me.Text = dropdown_1.GetCheckedItemsStringValue()
        End If
    End Sub
    ...
    Public Function GetItemCheckState(ByVal index As Integer) As CheckState
        If index < 0 OrElse index > Items.Count Then
            Throw New ArgumentOutOfRangeException("index", "value out of range")
        Else
            Return dropdown_1.List.GetItemCheckState(index)
        End If
    End Function
    ...
    Public Sub SetItemCheckState(ByVal index As Integer, ByVal state As CheckState)
        If index < 0 OrElse index > Items.Count Then
            Throw New ArgumentOutOfRangeException("index", "value out of range")
        Else
            dropdown_1.List.SetItemCheckState(index, state)
            ' Need to update the Text.
            Me.Text = dropdown_1.GetCheckedItemsStringValue()
        End If
    End Sub
