...
Public Class RptServiceManager
    Implements IRptServiceManager
...
#Region "Singleton Design Pattern - Fully Thread Safety"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared ReadOnly Property getInstance() As RptServiceManager
        Get
    ...
    Private Class Nested
        ...
        Public Shared ReadOnly instance As New RptServiceManager()
    End Class

#End Region

    Private Function getRptServiceClient() As RptServiceClient
        Dim client As New RptServiceClient
