...
Public Class IccServiceManager
    Implements IIccServiceManager
...
#Region "Singleton Design Pattern - Fully Thread Safety"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared ReadOnly Property getInstance() As IccServiceManager
        Get
    ...
    Private Class Nested
        ...
        Public Shared ReadOnly instance As New IccServiceManager()
    End Class

#End Region

    Private Function getIccService() As IccServiceClient
        Dim client As New IccServiceClient()
    ...
    Private Function getIccService2() As IccService2Client
        Dim client As New IccService2Client()
        'client.ClientCredentials.Windows.ClientCredential.Domain = Domain
        client.ClientCredentials.Windows.ClientCredential.UserName = UserName
        client.ClientCredentials.Windows.ClientCredential.Password = Password
        Return client
    ...
    Private Function getIccServiceL() As IccServiceLClient
