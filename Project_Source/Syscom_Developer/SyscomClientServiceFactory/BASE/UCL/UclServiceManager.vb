...
Public Class UclServiceManager
    Implements IUclServiceManager
...
#Region "Singleton Design Pattern - Fully Thread Safety"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared ReadOnly Property getInstance() As UclServiceManager
        Get
    ...
    Private Class Nested
        ...
        Public Shared ReadOnly instance As New UclServiceManager()
    End Class

#End Region

    Private Function getUclService() As UclServiceClient
        Dim client As New UclServiceClient
