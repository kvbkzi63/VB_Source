...
Public Class IccUploadLogDataTableFactory
    'Syscom's CodeGen Produced This VB Code @ 2015/11/4 上午 09:42:17
    Public Shared ReadOnly tableName as String="ICC_Upload_Log"
    '欄位名稱
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = IccUploadLogDataTableFactory.getDataTableWithSchema 
    ...
    Public Shared Function getDataTableWithSchema() As DataTable
        Try
            ...
            dt.Columns.Add("UploadDate")
            dt.Columns("UploadDate").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("DownloadDate")
            dt.Columns("DownloadDate").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("DownloadFlag")
