...
Public Class IccPreventDataDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = IccPreventDataDataTableFactory.getDataTableWithSchema 
        Dim dataRow As DataRow = dataTable.NewRow() 
        '使用自己的資料來源取代 New Object 
        dataRow("Card_Sn") = New Object
        dataRow("Row_No") = New Object
        dataRow("Service_Item_Id") = New Object
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            dt.Columns.Add("Service_Item_Id")
    ...
    Public Shared Function getDataTableWithSchema() As DataTable
        Try
            ...
            dt.Columns.Add("Service_Item_Id")
            dt.Columns("Service_Item_Id").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("ExamDate")
