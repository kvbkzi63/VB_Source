...
Public Class NfcGroupMaintainDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = NfcGroupMaintainDataTableFactory.getDataTableWithSchema 
