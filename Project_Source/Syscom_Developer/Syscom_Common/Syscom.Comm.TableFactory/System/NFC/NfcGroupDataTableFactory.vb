...
Public Class NfcGroupDataTableFactory
    'Syscom's CodeGen Produced This VB Code @ 2015/3/20 上午 12:09:52
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = NfcGroupDataTableFactory.getDataTableWithSchema 
