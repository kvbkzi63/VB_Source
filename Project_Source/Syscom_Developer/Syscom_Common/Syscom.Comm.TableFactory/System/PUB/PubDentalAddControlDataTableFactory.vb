...
Public Class PubDentalAddControlDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubDentalAddControlDataTableFactory.getDataTableWithSchema 
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            pkColArray(2) = dt.Columns("Doctor_Code")
