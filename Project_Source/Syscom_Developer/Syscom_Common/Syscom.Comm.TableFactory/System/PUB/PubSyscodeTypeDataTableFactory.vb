...
Public Class PubSyscodeTypeDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubSyscodeTypeDataTableFactory.getDataTableWithSchema 
        Dim dataRow As DataRow = dataTable.NewRow() 
        '使用自己的資料來源取代 New Object 
        dataRow("Type_Id") = New Object
        dataRow("Type_Name") = New Object
  ...
  Class PUBSyscodeTypePt
    ...
    Private m_Type_Name As String = "Type_Name"
    Public ReadOnly Property Type_Name() As System.String 
    Get
        Return m_Type_Name
    End Get
    End Property
