...
Public Class PubContractPartSetDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubContractPartSetDataTableFactory.getDataTableWithSchema 
