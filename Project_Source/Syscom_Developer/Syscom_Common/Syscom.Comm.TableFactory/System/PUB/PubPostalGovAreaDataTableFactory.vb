...
Public Class PubPostalGovAreaDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubPostalGovAreaDataTableFactory.getDataTableWithSchema 
