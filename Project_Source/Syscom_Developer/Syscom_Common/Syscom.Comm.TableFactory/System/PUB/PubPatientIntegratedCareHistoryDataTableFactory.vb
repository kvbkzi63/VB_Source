...
Public Class PubPatientIntegratedCareHistoryDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubPatientIntegratedCareHistoryDataTableFactory.getDataTableWithSchema 
        Dim dataRow As DataRow = dataTable.NewRow() 
        '使用自己的資料來源取代 New Object 
        dataRow("Care_Year") = New Object
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            pkColArray(0) = dt.Columns("Care_Year")
            pkColArray(1) = dt.Columns("Chart_No")
    ...
    Public Shared Function getDataTableWithSchema() As DataTable
        Try
            Dim dt As DataTable = New DataTable(tableName)
            dt.Columns.Add("Care_Year")
            dt.Columns("Care_Year").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("Chart_No")
  ...
  Class PUBPatientIntegratedCareHistoryPt
    Private m_Care_Year As String = "Care_Year"
    Public ReadOnly Property Care_Year() As System.String 
    Get
        Return m_Care_Year
    End Get
    End Property
