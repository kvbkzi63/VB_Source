...
Public Class PubSubIdentitySetDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubSubIdentitySetDataTableFactory.getDataTableWithSchema 
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            pkColArray(2) = dt.Columns("Order_Type_Id")
            pkColArray(3) = dt.Columns("Account_Id")
