...
Public Class PubPhaServicesDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubPhaServicesDataTableFactory.getDataTableWithSchema 
        Dim dataRow As DataRow = dataTable.NewRow() 
        '使用自己的資料來源取代 New Object 
        dataRow("Main_Identity_Id") = New Object
        dataRow("Dept_Code") = New Object
        dataRow("Pha_Services_Type_Id") = New Object
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            dt.Columns.Add("Pha_Services_Type_Id")
            ...
            pkColArray(0) = dt.Columns("Main_Identity_Id")
            pkColArray(1) = dt.Columns("Dept_Code")
            pkColArray(2) = dt.Columns("Pha_Services_Type_Id")
    ...
    Public Shared Function getDataTableWithSchema() As DataTable
        Try
            ...
            dt.Columns.Add("Pha_Services_Type_Id")
            dt.Columns("Pha_Services_Type_Id").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("Order_Code")
  ...
  Class PUBPhaServicesPt
    ...
    Private m_Pha_Services_Type_Id As String = "Pha_Services_Type_Id"
    Public ReadOnly Property Pha_Services_Type_Id() As System.String 
    Get
        Return m_Pha_Services_Type_Id
    End Get
    End Property
