...
Public Class PubMajorcareAddDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubMajorcareAddDataTableFactory.getDataTableWithSchema 
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            pkColArray(1) = dt.Columns("Majorcare_Code")
