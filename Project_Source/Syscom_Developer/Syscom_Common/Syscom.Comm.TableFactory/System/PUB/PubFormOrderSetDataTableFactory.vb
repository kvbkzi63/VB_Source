...
Public Class PubFormOrderSetDataTableFactory
    ...
    Public Shared ReadOnly columnsName As String() = New String() { _
             "Order_Code", "Form_Type_Id", "Form_Code"}
    '欄位型態
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubFormOrderSetDataTableFactory.getDataTableWithSchema 
