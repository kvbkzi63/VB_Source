...
Public Class PubRegisterFeeDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubRegisterFeeDataTableFactory.getDataTableWithSchema 
        Dim dataRow As DataRow = dataTable.NewRow() 
        '使用自己的資料來源取代 New Object 
        dataRow("Source_Id") = New Object
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            pkColArray(0) = dt.Columns("Source_Id")
            pkColArray(1) = dt.Columns("Sub_Identity_Code")
            pkColArray(2) = dt.Columns("First_Reg")
            pkColArray(3) = dt.Columns("Dept_Code")
            pkColArray(4) = dt.Columns("Section_Id")
            pkColArray(5) = dt.Columns("Medical_Type_Id")
    ...
    Public Shared Function getDataTableWithSchema() As DataTable
        Try
            Dim dt As DataTable = New DataTable(tableName)
            dt.Columns.Add("Source_Id")
            dt.Columns("Source_Id").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("Sub_Identity_Code")
  ...
  Class PUBRegisterFeePt
    Private m_Source_Id As String = "Source_Id"
    Public ReadOnly Property Source_Id() As System.String 
    Get
        Return m_Source_Id
    End Get
    End Property
