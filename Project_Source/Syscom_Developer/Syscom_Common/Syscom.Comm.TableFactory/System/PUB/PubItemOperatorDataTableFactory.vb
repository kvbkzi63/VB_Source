...
Public Class PubItemOperatorDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PubItemOperatorDataTableFactory.getDataTableWithSchema 
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            pkColArray(1) = dt.Columns("Operator_Code")
