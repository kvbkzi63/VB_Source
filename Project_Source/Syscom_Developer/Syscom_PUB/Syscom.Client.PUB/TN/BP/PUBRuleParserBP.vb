Public Class PUBRuleParserBP
    ...
    Private Shared myInstance As PUBRuleParserBP
    Public Shared Function GetInstance() As PUBRuleParserBP
        If myInstance Is Nothing Then
            myInstance = New PUBRuleParserBP()
        End If
        Return myInstance
    End Function
