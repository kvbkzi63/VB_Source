...
'*              Title:	PubOrderExamNoPrintDeptUI
'*        Description:	參考PubOrderExamNocheckinDeptUI
...
Public Class PubOrderExamNoPrintDeptUI
...
#Region "     使用的Instance宣告 "
    ...
    Private Shared myInstance As PubOrderExamNoPrintDeptUI
    Public Shared Function GetInstance() As PubOrderExamNoPrintDeptUI
        If myInstance Is Nothing Then
            myInstance = New PubOrderExamNoPrintDeptUI
        End If
        Return myInstance
    End Function
...
#Region "     儲存 "
    ...
    Private Function SaveData() As Boolean
        ...
        Try
            ...
            Try
                deleteCount = Pub.PUBOrderExamNoPrintDeptdelete(m_Order_Code)
            Catch ex As Exception
                Throw New CommonException("CMMCMMB915", "PUBOrderExamIsNoPrintDeptdelete")
            End Try

            If CheckMethodUtil.CheckHasValue(ds) Then
                Try
                    insertCount = Pub.PUBOrderExamNoPrintDeptinsert(ds)
                Catch ex As Exception
                    Throw New CommonException("CMMCMMB915", "PUBOrderExamIsNoPrintDeptinsert")
                End Try
            End If
...
#Region "     載入事件管理員(EventManager) "
    ...
    ''' </summary>
    ''' <remarks>by Michelle on 2017-4-13</remarks>
...
#End Region
    ...
    Private Sub setDgvOEI()
        Dim ds As DataSet = Pub.getInitialOrderExamNoPrintDept(Me.m_Order_Code)
