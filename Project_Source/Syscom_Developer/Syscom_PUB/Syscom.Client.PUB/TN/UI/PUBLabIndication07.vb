...
Public Class PUBLabIndication07
    Inherits BaseFormUI
...
#Region "     使用的Instance宣告 "
    ...
    Private Shared myInstance As PUBLabIndication07
    Public Shared Function GetInstance() As PUBLabIndication07
        If myInstance Is Nothing Then
            myInstance = New PUBLabIndication07
        End If
        Return myInstance
    End Function
...
#Region "     儲存 "
    ...
    Private Function SaveData() As Boolean
        ...
        Try
            ...
            If errorCode Then
                returnBoolean = False
                MessageHandling.ShowWarnMsg("請輸入臨床診斷敘述！")
...
#Region "     取得勾選的Dataset資料 "
    ...
    Private Function getCheckDataByDataSet() As DataSet
        ...
        rowDt1.Item("特殊屬性表單代碼") = "PUBLabIndication07"
        rowDt1.Item("特殊屬性表單名稱") = "病理細胞申請單"
        dsCheckData.Tables(0).Rows.Add(rowDt1)
        '--------------------------------------------------------------------------------
        'Dataset:建第2個table
        dsCheckData.Tables.Add()
        dsCheckData.Tables(1).TableName = "臨床診斷敘述"
        dsCheckData.Tables(1).Columns.Add("臨床診斷敘述內容")

        '存值入各欄位
        Dim rowDt2 As DataRow = dsCheckData.Tables(1).NewRow
        rowDt2.Item("臨床診斷敘述內容") = nvl(txt_Diagnosis.Text)
    ...
    Private Function getCheckDataByArray() As String()
        ...
        pvtResult(1) = "臨床診斷敘述：" & nvl(txt_Diagnosis.Text)
