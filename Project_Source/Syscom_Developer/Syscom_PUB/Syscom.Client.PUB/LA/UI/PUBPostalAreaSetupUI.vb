...
Public Class PUBPostalAreaSetupUI
...
#Region "     *Table 欄位 "
    ...
    '存檔的Table欄位
    Private gblColumnNameDB As String() = PubPostalAreaDataTableFactory.columnsName

    '存檔的Table Name
    Private gblTableName As String = PubPostalAreaDataTableFactory.tableName

    '空的DT，清空資料使用
    Private gblEmptyDT As DataTable = PubPostalAreaDataTableFactory.getDataTable

    '要顯示在畫面上的Grid 中文標頭，不顯示的也要有名稱
    Private gblColumnTextDgv As String = "郵遞區號,戶籍地代碼"
...
#Region "     *新增 "
    ...
    Public Overrides Function InsertData() As Boolean
        ...
        Try
            ...
            '寫入資料庫
            Dim count As Integer = PUB.PUBPostalAreaInsertByPK(InsertDS)
            ...
            If count > 0 Then
                ...
                'updateDataGridView(iButtonFlag, PUB.PUBPostalAreaQueryByPKAll(txt_PostalCode.Text, txt_AreaCode.Text))
                queryDS = PUB.queryPostalAreaAll()
...
#Region "     *修改 "
    ...
    Public Overrides Function updateData() As Boolean
        ...
        Try
            ...
            '寫入資料庫
            Dim count As Integer = PUB.PUBPostalAreaUpdateByPK(updateDS)
...
#Region "     *刪除 "
    ...
    Public Overrides Function deleteData() As Boolean
        ...
        Try
            ...
            '自資料庫刪除
            count = PUB.PUBPostalAreadeleteChoose(dsDelete)
    ...
    Public Overrides Function queryData() As Boolean
        ...
        Try
            ...
            If txt_PostalCode.Text <> "" Then
                queryDS = PUB.PUBPostalAreaQueryByPK(txt_PostalCode.Text)
            Else
                queryDS = PUB.queryPostalAreaAll()
            End If
            '*******************************************************************************
...
#Region "     *欄位檢查 - True 檢查不通過;False 檢查通過 "
    ...
    Public Function fieldCheckResult(ByVal iButtonFlag As Integer) As Boolean
        ...
        Try
            ...
            Dim objCheck2 As UCLTextBoxUC = txt_AreaCode
            Dim errorStr2 As String = "戶籍地代碼"
