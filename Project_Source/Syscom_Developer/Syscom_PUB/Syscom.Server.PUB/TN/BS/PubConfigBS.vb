...
Public Class PubConfigBS

    Public Shared ReadOnly tableName As String = "PUB_Config"

#Region "########## getInstance ##########"

    Private Shared myInstance As PubConfigBS

    Public Overloads Function getInstance() As PubConfigBS
        If myInstance Is Nothing Then
            myInstance = New PubConfigBS()
        End If
        Return myInstance
    End Function
...
#Region "     存檔 "
    ...
    Public Function savePubConfig(ByVal inSaveDs As DataSet) As DataSet
        ...
        Dim m_Pub_Config As PubConfigBO_E1 = PubConfigBO_E1.getInstance
        ...
        Try
            ...
            resultDs.Tables("Save_Result").Columns.Add("Config_Name")
                ...
                For i = 0 To inSaveDs.Tables(0).Rows.Count - 1
                    ...
                    Try
                        ...
                        If inSaveDs.Tables(0).Rows(i).Item("Status").ToString.Trim = "I" Then
                            ...
                            m_Pub_Config.insertPUBConfigByRowData(inSaveDs.Tables(0).Rows(i).Item("Config_Name").ToString.Trim,
                                                                  inSaveDs.Tables(0).Rows(i).Item("Config_Description").ToString.Trim,
                                                                  inSaveDs.Tables(0).Rows(i).Item("Config_Value").ToString.Trim,
                        ...
                        Else
                            ...
                            m_Pub_Config.updatePUBConfigByRowData(inSaveDs.Tables(0).Rows(i).Item("Config_Name").ToString.Trim,
                                                                  inSaveDs.Tables(0).Rows(i).Item("Config_Description").ToString.Trim,
                                                                  inSaveDs.Tables(0).Rows(i).Item("Config_Value").ToString.Trim,
                                                                  inSaveDs.Tables(0).Rows(i).Item("Modified_User").ToString.Trim,
                                                                  inSaveDs.Tables(0).Rows(i).Item("Modified_Time").ToString.Trim,
                    ...
                    Catch sql_ex As SqlException
                        ...
                        resultDs.Tables(0).Rows(pvtErrorCount).Item("Config_Name") = inSaveDs.Tables(0).Rows(pvtIndex).Item("Config_Name")
...
#Region "     刪除 "
    ...
    Public Function deletePubConfig(ByVal inDeleteDs As DataSet) As DataSet
        ...
        Try
            ...
            resultDs.Tables("Maintain_Time").Rows.Add()
            resultDs.Tables("Maintain_Time").NewRow()
            resultDs.Tables("Maintain_Time").Rows(0).Item("Server_Time") = pvtSystemTime
            ...
            Using conn As System.Data.IDbConnection = CType(getConnection(), SqlConnection)
                ...
                For i = 0 To inDeleteDs.Tables(0).Rows.Count - 1
                    ...
                    Try
                        ...
                        m_Pub_Config.deletePubConfigByPK(inDeleteDs.Tables(0).Rows(i).Item("Config_Name").ToString.Trim, conn)
                    ...
                    Catch sqlex As SqlException
                        ...
                        resultDs.Tables(0).Rows.Add()
                        resultDs.Tables(0).NewRow()
                        resultDs.Tables(0).Rows(pvtErrorCount).Item("Config_Name") = inDeleteDs.Tables(0).Rows(pvtIndex).Item("Config_Name")
