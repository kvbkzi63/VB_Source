...
'*              Title:	PubOrderExamNoPrintDeptBS
'*        Description:	查詢
...
Public Class PubOrderExamNoPrintDeptBS

#Region "     使用的Instance宣告 "

    Private Shared myInstance As PubOrderExamNoPrintDeptBS
    Public Overloads Shared Function GetInstance() As PubOrderExamNoPrintDeptBS
        If myInstance Is Nothing Then
            myInstance = New PubOrderExamNoPrintDeptBS
        End If
        Return myInstance
    End Function
...
#Region "     變數宣告 "
    ...
    Dim tableName As String = "PUB_Order_Exam_NoPrint_Dept"
...
#Region " 取得門急住個別的不需列印科別 "
    ...
    Public Function getInitialOrderExamNoPrintDept(ByVal orderCode As String, Optional ByRef conn As System.Data.IDbConnection = Nothing) As DataSet
        ...
        Try
            ...
            strBuilder.AppendLine("Left Join  PUB_Order_Exam_NoPrint_Dept B ")
