...
Public Class PUBEmgAddBO_E1
    Inherits PubEmgAddBO

#Region "########## getInstance ##########"

    Private Shared instance As PUBEmgAddBO_E1

    Public Overloads Shared Function getInstance() As PUBEmgAddBO_E1
        If instance Is Nothing Then
            instance = New PUBEmgAddBO_E1
        End If
        Return instance
    End Function
...
#End Region
    ...
    ''' 1.2009/09/24, XXX
    ''' </修改註記>
    Public Function queryActiveEmgAddData(ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal EffectDate As Date) As DataTable
    ...
    ''' 1.2009/09/24, XXX
    ''' </修改註記>
    Public Function queryEmgAddByCondition(ByVal Condition As DataTable) As DataTable
    ...
    Public Overloads Function delete(ByRef inOrderCode As System.String, Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            Dim sqlString As String = "Delete From PUB_Emg_Add " & _
    ...
    ' "20110907 Immy --- 急件加成查詢"
    Public Function QueryAdd_EMG(ByVal Order_Code As String) As DataTable
        Dim cmdStr As New StringBuilder
        '----------------------------------------------------------------------------
        'Select SQL
        '----------------------------------------------------------------------------
        cmdStr.AppendLine("select A.order_code as 院內碼,A.Effect_Date as 生效日, B.Code_Name as 主身份, C.Code_Name as 門急住, A.Emg_Add_Ratio as 加成率, A.End_Date as 結束日 ")
        '----------------------------------------------------------------------------
        'From&Join SQL
        '----------------------------------------------------------------------------
        cmdStr.AppendLine("from PUB_Emg_Add as A left join pub_syscode as B ON A.Main_Identity_Id = B.Code_Id and B.Type_Id='18' ")
    ...
    Public Function queryEmgAddData(ByVal EffectDate As String, ByVal EffectDateSymbol As String, ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal PtFromId As String, ByVal Dc As String) As DataTable
    ...
    Public Function DeletePUBEmgAddByEffectDateAndDc(ByVal EffectDate As String, ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal PtFromId As String) As Integer
    ...
    Public Function updatePUBEmgAddEndDateAndDc(ByVal EffectDate As String, ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal PtFromId As String, _
