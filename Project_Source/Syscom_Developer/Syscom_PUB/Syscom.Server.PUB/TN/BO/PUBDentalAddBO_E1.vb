...
Public Class PUBDentalAddBO_E1
    Inherits PubDentalAddBO

#Region "########## getInstance ##########"

    Private Shared instance As PUBDentalAddBO_E1

    Public Overloads Shared Function getInstance() As PUBDentalAddBO_E1
        If instance Is Nothing Then
            instance = New PUBDentalAddBO_E1
        End If
        Return instance
    End Function
...
#End Region
    ...
    ''' <使用表單>
    ''' 1.Jen-PUB_Dental_Add
    ''' </使用表單>
    ''' <修改註記>
    ''' 1.2009/09/24, XXX
    ''' </修改註記>
    Public Function queryActiveDentalAddData(ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal EffectDate As Date) As DataTable
    ...
    ''' 1.2009/09/24, XXX
    ''' </修改註記>
    Public Function queryDentalAddByCondition(ByVal Condition As DataTable) As DataTable
        ...
        If DataSetUtil.IsContainsData(Condition) Then
            ...
            '"Effect_Date", "Main_Identity_Id", "Pt_From_Id", "Order_Code", "End_Date"
    ...
    Public Overloads Function delete(ByRef inOrderCode As System.String, Optional ByRef conn As System.Data.IDbConnection = Nothing) As Integer
        ...
        Try
            ...
            Dim sqlString As String = "Delete From PUB_Dental_Add " & _
    ...
    ' "20110907 Immy --- 牙科轉診加成查詢"
    Public Function QueryAdd_Dental(ByVal Order_Code As String) As DataTable
        Dim cmdStr As New StringBuilder
        '----------------------------------------------------------------------------
        'Select SQL
        '----------------------------------------------------------------------------
        cmdStr.AppendLine("select A.order_code as 院內碼,A.Effect_Date as 生效日, B.Code_Name as 主身份, C.Code_Name as 門急住, A.Dental_Add_Ratio as 加成率, A.End_Date as 結束日 ")
        '----------------------------------------------------------------------------
        'From&Join SQL
        '----------------------------------------------------------------------------
        cmdStr.AppendLine("from PUB_Dental_Add as A left join pub_syscode as B ON A.Main_Identity_Id = B.Code_Id and B.Type_Id='18' ")
    ...
    Public Function queryDentalAddData(ByVal EffectDate As String, ByVal EffectDateSymbol As String, ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal PtFromId As String, ByVal Dc As String) As DataTable
        ...
        cmdStrOrder.AppendLine("Order By Effect_Date Desc,Order_Code,Main_Identity_Id,Pt_From_Id ")
    ...
    Public Function DeletePUBDentalAddByEffectDateAndDc(ByVal EffectDate As String, ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal PtFromId As String) As Integer
        ...
        Try
            ...
            Dim sqlString As String = "Delete From " & tableName & " " & _
                                      "Where  Effect_Date>=@Effect_Date and Order_Code=@Order_Code and Main_Identity_Id=@Main_Identity_Id and Pt_From_Id=@PtFromId "
    ...
    Public Function updatePUBDentalAddEndDateAndDc(ByVal EffectDate As String, ByVal OrderCode As String, ByVal MainIdentityId As String, ByVal PtFromId As String, _
