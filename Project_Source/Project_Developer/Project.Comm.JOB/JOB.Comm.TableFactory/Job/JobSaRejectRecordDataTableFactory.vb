...
Public Class JobSaRejectRecordDataTableFactory
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = JobSaRejectRecordDataTableFactory.getDataTableWithSchema 
        Dim dataRow As DataRow = dataTable.NewRow() 
        '使用自己的資料來源取代 New Object 
        dataRow("JOB_Code") = New Object
        dataRow("Reply_Seq") = New Object
        dataRow("Reply_Note") = New Object
    ...
    Public Shared Function getDataTable() As DataTable
        Try
            ...
            dt.Columns.Add("Reply_Seq")
            dt.Columns.Add("Reply_Note")
            dt.Columns.Add("FID")
            ...
            pkColArray(1) = dt.Columns("Reply_Seq")
    ...
    Public Shared Function getDataTableWithSchema() As DataTable
        Try
            ...
            dt.Columns.Add("Reply_Seq")
            dt.Columns("Reply_Seq").DataType = System.Type.GetType("System.Int32")
            dt.Columns.Add("Reply_Note")
            dt.Columns("Reply_Note").DataType = System.Type.GetType("System.String")
            dt.Columns.Add("FID")
  ...
  Class JOBSARejectRecordPt
    ...
    Private m_Reply_Seq As String = "Reply_Seq"
    Public ReadOnly Property Reply_Seq() As System.String 
    Get
        Return m_Reply_Seq
    End Get
    End Property

    Private m_Reply_Note As String = "Reply_Note"
    Public ReadOnly Property Reply_Note() As System.String 
    Get
        Return m_Reply_Note
    End Get
    End Property
