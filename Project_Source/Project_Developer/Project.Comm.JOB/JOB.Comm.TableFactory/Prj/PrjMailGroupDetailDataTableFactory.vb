...
Public Class PrjMailGroupDetailDataTableFactory
    'Syscom's CodeGen Produced This VB Code @ 2017/6/16 下午 01:19:44
    ...
    Private sub example() 
        ...
        Dim dataTable As DataTable = PrjMailGroupDetailDataTableFactory.getDataTableWithSchema 
